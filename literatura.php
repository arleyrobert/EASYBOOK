...
<div class="card-deck">
 ...
 $db=new Conect_MySql();
       // $id = filter_input(INPUT_GET, 'id_categoria', FILTER_SANITIZE_NUMBER_INT);
            $sql = "select * from categorias inner join pdf on categorias.id_categoria = pdf.id_categoria where nome_categoria like '%Literatura%' order by id_pdf desc limit 4";
